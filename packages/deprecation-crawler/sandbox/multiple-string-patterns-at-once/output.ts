...
/**
 * @deprecated This is deprecated IMPORTANT!. See {@link info} for xyz. Details: {@link sandbox-deprecation-link#3477709142}
 * Example: 3 pattern match with other start
 */
const multiPatternMatch2 = 0;

/**
 * @deprecated `t2` is deprecated. See {@link info} for xyz and related things. Details: {@link sandbox-deprecation-link#2417065367}
