...
export function concat<I>(processes: CrawlerProcess<I, I>[]): CrawlerProcess<I, I> {
...
export function tap<I>(process: CrawlerProcess<I, I | void>): CrawlerProcess<I, I> {
  return async function(d: I): Promise<I> {
    await process(d);
...
export function askToSkip<I>(question: string, process: CrawlerProcess<I, I>): CrawlerProcess<I, I> {
  return async function(d: I): Promise<I> {
